...
public class ReturnToSpawn : MonoBehaviour
{
    ...
    private BallTrajectoryAdjustment ballTrajectoryAdjustment;
    ...
    void Start()
    {
        ...
        ballTrajectoryAdjustment = GetComponent<BallTrajectoryAdjustment>();
    ...
    private IEnumerator CheckPositionAndReset()
    {
        while (true)
        {
            if (transform.position.y < minY)
            {
                ...
                ballTrajectoryAdjustment.DisableCurve();
            }
